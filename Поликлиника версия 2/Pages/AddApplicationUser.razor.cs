...
namespace Polyclinic.Pages
{
    public partial class AddApplicationUser
    {
        ...
        protected Polyclinic.Models.ApplicationUser user;
        ...
        {
            user = new Polyclinic.Models.ApplicationUser();

            roles = await Security.GetRoles();
        }

        protected async Task FormSubmit(Polyclinic.Models.ApplicationUser user)
        {
            try
            {
