...
namespace Polyclinic.Controllers
{
    public partial class ExportController : Controller
    {
        ...
        public FileStreamResult ToCSV(IQueryable query, string fileName = null)
        {
            ...
            var result = new FileStreamResult(new MemoryStream
                (UTF8Encoding.Default.GetBytes($"{string.Join(",", columns.Select
                (c => c.Key))}{System.Environment.NewLine}{sb.ToString()}")), "text/csv");
